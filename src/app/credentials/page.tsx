      ...
      <BlurFade delay={BLUR_FADE_DELAY * 4}>
        <div className="flex flex-col md:flex-row gap-4 mb-8 items-center justify-between">
          ...
          <div className="relative w-full md:w-48 shrink-0">
            <select
              value={activeTab}
              onChange={(e) => setActiveTab(e.target.value as "all" | "coursera" | "guvi")}
              className="w-full h-10 pl-4 pr-10 py-2 text-xs font-semibold bg-background/50 border border-border/80 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all cursor-pointer appearance-none text-foreground"
            >
              <option value="all" className="bg-background text-foreground">All Platforms</option>
              <option value="coursera" className="bg-background text-foreground">Coursera</option>
              <option value="guvi" className="bg-background text-foreground">HCL GUVI</option>
            </select>
